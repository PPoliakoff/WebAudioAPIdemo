...
function create_adsr_panel(title) {
    const my_div = document.createElement("div");
    my_div.classList = "module";
    my_div.style.backgroundColor = "rgb(128,128,255)";
    my_div.style.display = "grid";
    document.getElementById("my_audio_rack").appendChild(my_div);

    const my_div_a = document.createElement("div");
    my_div_a.innerHTML = "Attack";
    my_div.appendChild(my_div_a);
    const a_slider = document.createElement("input");
    a_slider.style.float = "right";
    a_slider.setAttribute("type", "range");
    my_div_a.appendChild(a_slider);

    const my_div_d = document.createElement("div");
    my_div_d.innerHTML = "Decay";
    my_div.appendChild(my_div_d);
    const d_slider = document.createElement("input");
    d_slider.style.float = "right";
    d_slider.setAttribute("type", "range");
    my_div_d.appendChild(d_slider);

    const my_div_s = document.createElement("div");
    my_div_s.innerHTML = "Sustain";
    my_div.appendChild(my_div_s);
    const s_slider = document.createElement("input");
    s_slider.style.float = "right";
    s_slider.setAttribute("type", "range");
    my_div_s.appendChild(s_slider);

    const my_div_r = document.createElement("div");
    my_div_r.innerHTML = "Release";
    my_div.appendChild(my_div_r);
    const r_slider = document.createElement("input");
    r_slider.setAttribute("type", "range");
    my_div_r.appendChild(r_slider);
    return new ADSR_PANEL(a_slider, d_slider, s_slider, r_slider);
}
// ============ MAIN PROGRAM ==========================
...
//=================================
//create a adsr VCA
const adsr_vca = audio_ctx.createGain();
adsr_vca.gain.value = 0;

const adsr_panel = create_adsr_panel("ADSR");
